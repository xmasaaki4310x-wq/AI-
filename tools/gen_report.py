...
JA_TITLES = {
    ...
    "Nvidia agrees to buy Hugging Face for about $12.9 billion, identifying the buyer in the sale process reported days earlier":
        "Nvidia、Hugging Faceを約129億ドルで買収することに合意—数日前に報じられた売却協議の買い手が判明",
...
ITEMS = [
    ...
    ("Nvidia agrees to buy Hugging Face for about $12.9 billion, identifying the buyer in the sale process reported days earlier",
     ...
     "CNBC", 8, "2026-08-27", "SEEN", 12,
     "買収・提携、市場動向", "market",
     ["source weight +8", "market", "acquisition", "fresh"],
     "Nvidia reached an agreement to acquire Hugging Face for roughly $12.9 billion, according to The Information, resolving the buyer question left open when Hugging Face's sale process first surfaced days earlier -- though the deal is not yet signed and could still fall through. Owning the most widely used open-source model-hosting platform would deepen Nvidia's reach into the software and model ecosystem and could give it a path back into cloud computing by monetizing otherwise-idle capacity."),
    ("Nvidia discusses an equity investment in Perplexity at a valuation of more than $30 billion",
    ...
    ("Forcepoint researchers hijack AI email summaries using invisible HTML prompt injection, altering a deadline and deleting a name",
     ...
     "Forcepoint", 4, "2026-08-28", "SEEN", 10,
     "規制・リスク、AIエージェント", "risk",
    ...
    ("Sony Music Publishing and Warner Chappell sue Anthropic and its co-founders, alleging a 'brazen campaign' of torrenting copyrighted songs to train Claude",
     ...
     "TechCrunch AI", 16, "2026-08-29", "SEEN", 22,
     "規制・リスク", "risk",
    ...
    ("DeepSeek nears a $7.4 billion funding round at a $74 billion valuation ahead of a planned 2027 Shanghai IPO",
     ...
     "Tech Startups", 4, "2026-08-28", "SEEN", 16,
     "市場動向、法人導入", "market",
    ...
    ("EU designates ChatGPT a Very Large Online Search Engine under the DSA, its toughest platform rules, with 159 million EU users",
     ...
     "Winbuzzer", 4, "2026-08-31", "SEEN", 27,
     "規制・リスク", "risk",
    ...
    ("Anthropic signs a $35 billion cloud deal with Nvidia-backed Lambda for a Texas data center, its second mega-compute deal this month",
     ...
     "Bloomberg", 8, "2026-08-31", "SEEN", 23,
     "クラウド、買収・提携", "partner",
     ["source weight +8", "cloud", "compute", "partnership", "fresh"],
    ...
    ("Google launches agentic video understanding in Gemini, cutting analysis costs up to 66% and token use up to 88%",
     ...
     "Google AI Blog", 16, "2026-09-01", "NEW", 22,
     "モデル/API、AIエージェント", "model",
